...
typedef __int32 hTCB;
typedef __int32 hACB;
typedef __int32 hMBX;
typedef __int32 hMSG;
...
typedef struct tagMSG align(64) {
	unsigned __int32 link;
	unsigned __int32 retadr;    // return address
	unsigned __int32 tgtadr;    // target address
